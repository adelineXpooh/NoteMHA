...
import com.mha.note.ui.record.RecordFragment

class FirstContainer : BaseContainer(), LifecycleObserver{
    ...
    private fun initView() {
        replaceFragment(FragmentTags.FRAGMENT_RECORD, RecordFragment(), false)
    }
}